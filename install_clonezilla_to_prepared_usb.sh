...
curl --verbose --location https://sourceforge.net/projects/clonezilla/files/clonezilla_live_alternative/"${latest_clonezilla_live_alternative_stable_version}"/clonezilla-live-"${latest_clonezilla_live_alternative_stable_version=}"-amd64.zip/download -o"/tmp/clonezilla_latest.zip"
# end of alternative - Ubuntu-based section

printf "A\n" | sudo unzip "/tmp/clonezilla_latest.zip" -d /mnt
